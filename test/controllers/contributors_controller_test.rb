...
class ContributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contributor" do
    assert_difference('Contributor.count') do
      post contributors_url, params: { contributor: { amount_share: @contributor.amount_share, max_limit: @contributor.max_limit, name: @contributor.name } }
    end
  ...
  test "should update contributor" do
    patch contributor_url(@contributor), params: { contributor: { amount_share: @contributor.amount_share, max_limit: @contributor.max_limit, name: @contributor.name } }
